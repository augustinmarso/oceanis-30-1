...
(() => {
  ...
  const CASES = ["153.4,132.9 156.4,131.8 166.4,129.7 173.5,128.5 191.2,127.6 199.7,128.6 204.3,130.1 210.6,132.7 218.6,136 228.6,140.2 229.6,141.3 216.5,144.6 200.5,148.5 197.2,148.6", "83.4,147.8 95.5,144.6 124.3,137.4 135,135.8 136.1,135.8 137.4,160.8 137.3,162.9 135.2,164.1 132,165.3 130.9,165.3 94.4,152", "208.4,150.9 212.4,149.8 226.5,145.5 246.4,142.2 247.4,142.3 247.3,166 244.2,165 214.4,154.2 209.4,152", "255.4,161.8 257.3,149.6 268.8,153.6 288.6,163 259.3,171.4 258.1,171.3 255.8,170.1", "140.4,168 141.4,166.9 152.4,163.7 174.3,157.4 192.3,154.1 194.4,154.1 194.1,189.1 191.1,189.2", "267.4,173.8 269.4,172.7 304.1,163.8 306.2,163.9 306.6,178.2 305.2,188.1 304.1,188.1 301,187.3 272.4,175.9", "80.4,183.7 87.5,181.5 126.2,171 127.6,186.9 127.2,208.1 110.5,200.5 83.4,185.8", "200.4,192.7 206.5,190.5 216.7,187 254.1,176.8 254.5,205.4 253.2,216 252.2,216 243,212.2 211.4,197.9", "135.4,212.9 138.4,211.8 179.9,198.6 187.1,196.8 188.1,196.9 188.1,234.1 184,234.3 167.8,229.6 155.6,223.8"];
  const jaugeSac = n => {
  ...
  V.sac = () => {
    ...
    return screen(null, `background:var(--neutral);--rond:${mix(Z.P.couleur, "#FFFFFF", 0.35)}`, `
      ...
      <div class="sac">
        ${jaugeSac(n)}
        <section><h2>Les ${SAC.length} indispensables à emporter</h2><div class="sac-grille">${objets}</div></section>
